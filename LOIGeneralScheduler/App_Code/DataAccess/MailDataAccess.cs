...
namespace LOIGeneralScheduler.App_Code.DataAccess
{
    public class MailDataAccess : DBConfiguration
    {
        ...
        public DataTable GetMailConfigurationBaseName(string configname)
        {
            ...
            return CustomExecuteCommand.ExecuteReaderDT(Command, Connection, "GenSchrMailDataAccess:GetMailConfigurationBaseName", "uspConfig_GetMailConfigurationBaseName");
        }
    }
}
