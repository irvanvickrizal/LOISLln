<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmDashboardSSP.aspx.cs" Inherits="Dashboard_frmDashboardSSP" %>
        ...
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                <div class="list-group">
                    <a href="#" id="aViewCheckingBOW" runat="server" class="list-group-item">
                        <i class="fa fa-edit fa-fw"></i><span class="text-danger">Checking BOQ Pricing Availability</span>
                        <span class="pull-right text-danger medium">
                            <asp:Literal ID="ltrCheckingBOWPendingCount" runat="server">0</asp:Literal>
                        </span>
                    </a>
                    <a href="#" id="aNotAvailableList" runat="server" class="list-group-item">
                        <i class="fa fa-edit fa-fw"></i><span class="text-danger">BOQ Pricing Document Not Available</span>
                        <span class="pull-right text-danger medium">
                            <asp:Literal ID="ltrNotAvailableList" runat="server">0</asp:Literal>
                        </span>
                    </a>
                    <a href="#" id="aRejectedPending" runat="server" class="list-group-item">
                        <i class="fa fa-edit fa-fw"></i><span class="text-danger">Checking LOI Rejected BOQ Pricing Availability</span>
                        <span class="pull-right text-danger medium">
