...
public partial class Dashboard_frmListLOIPCMRejected : System.Web.UI.Page
{
    ...
    protected void gvListLOI_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("UploadPrice"))
        {
            ...
            Response.Redirect("frmUploadLOIPriceRejected.aspx?RequestId=" + e.CommandArgument.ToString());
        }
    }
