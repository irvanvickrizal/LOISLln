...
public partial class Dashboard_frmDashboardFM : System.Web.UI.Page
{
    ...
    {
        int RejectedCount = loiControllerr.LOI_get_UploadedCount_byStatus("Rejected");
        if (RejectedCount > 0)
        {
            ltrRejectedPendingCount.Text = "<span class=\"pull-right text-muted medium\">" + RejectedCount + "</span>";
            aRejectedPending.HRef = "frmListLOIRejected.aspx";
        }
    }
