...
public partial class Dashboard_frmListLOICPMApproval : System.Web.UI.Page
{
    ...
    protected void gvListLOI_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("UploadPrice"))
        {
            ...
            Response.Redirect("frmApproval.aspx?RequestId=" + e.CommandArgument.ToString());
        }
    }
    ...
    {
        gvListLOI.DataSource = loiControllerr.LOI_get_Uploaded(5);
