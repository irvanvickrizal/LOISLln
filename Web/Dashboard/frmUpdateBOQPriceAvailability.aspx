<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmUpdateBOQPriceAvailability.aspx.cs" Inherits="Dashboard_frmUpdateBOQPriceAvailability" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="Server">
    <h4 class="text-info text-right"><i class="fa fa-list fa-fw"></i>Checking BOQ Price</h4>
