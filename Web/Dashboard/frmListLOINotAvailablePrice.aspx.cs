...
public partial class Dashboard_frmListLOINotAvailablePrice : System.Web.UI.Page
{
    ...
    protected void gvListLOI_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("UploadPrice"))
        {
            ...
            Response.Redirect("frmUpdateBOQPriceAvailability.aspx?RequestId=" + e.CommandArgument.ToString());
        }
    }
    ...
    {
        gvListLOI.DataSource = loiControllerr.Loi_NotAvailable_Price();
