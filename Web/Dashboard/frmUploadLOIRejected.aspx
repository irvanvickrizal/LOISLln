<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmUploadLOIRejected.aspx.cs" Inherits="Dashboard_frmUploadLOIRejected" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="Server">
    <div class="panel panel-info">
        <div class="panel-heading">
            <asp:Label ID="Label1" runat="server" Font-Bold="true" Text='Upload LOI' CssClass="h5" />
        </div>
        <div class="panel-body">
            ...
            <div class="row form-group">
                <div class="col-xs-5" style="text-align: left;">
                    ...
                    <asp:Button ID="btnDownloadTemplate" CssClass="btn btn-block btn-info" Text="Download Rejected LOI (.xlsx)" runat="server" OnClick="btnDownloadTemplate_Click" />
<%--                    <asp:Button ID="btnDownloanSubcon" CssClass="btn btn-block btn-info" Text="Download Subcon Code (.xlsx)" runat="server" OnClick="btnDownloanSubcon_Click" />--%>
