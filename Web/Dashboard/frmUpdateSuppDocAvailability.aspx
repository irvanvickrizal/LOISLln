<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmUpdateSuppDocAvailability.aspx.cs" Inherits="Dashboard_frmUpdateSuppDocAvailability" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="Server">
    <h4 class="text-info text-right"><i class="fa fa-list fa-fw"></i>Supporting Document Pricing Availability</h4>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <div class="col-lg-6">
                                                <asp:Button ID="btnNoConfirm" Width="100%" runat="server" Text="No" CssClass="btn btn-primary" CommandName="ConfirmNo" />
                                            </div>
                                            <div>
