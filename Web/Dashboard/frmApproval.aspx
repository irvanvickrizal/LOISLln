<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmApproval.aspx.cs" Inherits="Dashboard_frmApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="Server">
    ...
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
                    ...
                    <div class="form-group">
                        <asp:GridView ID="gvListLOIOverdue" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="30" CssClass="Grid" Width="100%" OnRowCommand="gvListLOIOverdue_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Aging" HeaderText="Overdue Aging" />
            ...
            <%--<div class="panel panel-primary">
                <div class="panel-heading">
                    <i class="fa fa-tasks fa-fw"></i>Agreement
                </div>
                <div class="panel-body">
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-4">
                            <asp:DropDownList ID="ddlAgreementNo" runat="server" CssClass="form-control" Width="100%"></asp:DropDownList>
                        </div>
                        <div class="col-md-2" style="text-align: right">
                            <asp:Label runat="server" ID="Label2" CssClass="control-label h5" Text='Price Agreement' Style="text-align: right" />
                        </div>
                        <div class="col-md-4">
                            <asp:DropDownList ID="ddlPriceAgreement" runat="server" CssClass="form-control" Width="100%"></asp:DropDownList>
                        </div>
                    </div>                    
                </div>
            </div>
