<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmDashboardCPM.aspx.cs" Inherits="Dashboard_frmDashboardCPM" %>
        ...
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                <div class="list-group">
                    <a href="#" id="aViewChecking" runat="server" class="list-group-item">
                        <i class="fa fa-edit fa-fw"></i><span class="text-danger">Checking Supporting Document</span>
                        <span class="pull-right text-danger medium">
                            <asp:Literal ID="ltrCheckingPendingCount" runat="server">0</asp:Literal>
                        </span>
                    </a>
                    <a href="#" id="aSupDocNotAvailable" runat="server" class="list-group-item">
                        <i class="fa fa-edit fa-fw"></i><span class="text-danger">Supporting Document Not Available</span>
                        <span class="pull-right text-danger medium">
                            <asp:Literal ID="ltrSupDocNotAvailable" runat="server">0</asp:Literal>
                        </span>
                    </a>
                    <a href="#" id="aViewApproval" runat="server" class="list-group-item">
                        <i class="fa fa-edit fa-fw"></i><span class="text-danger">LOI Approval Pending</span>
                        <span class="pull-right text-danger medium">
                    ...
                    <a href="#" id="aRejectedPending" runat="server" class="list-group-item">
                        <i class="fa fa-edit fa-fw"></i><span class="text-danger">LOI Rejected Checking Supp. Document</span>
                        <span class="pull-right text-danger medium">
