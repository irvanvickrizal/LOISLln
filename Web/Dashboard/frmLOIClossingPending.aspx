<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmLOIClossingPending.aspx.cs" Inherits="Dashboard_frmLOIClossingPending" %>
                    ...
                    <asp:TemplateField ItemStyle-Width="50px" HeaderStyle-CssClass="gridheader">
                        <ItemTemplate>
                            <div style="width: 100%; text-align: center;">
                                ...
                                <asp:ImageButton ID="imgUploadPrice" runat="server" ImageUrl="~/images/submission-icon.png" Width="25px" Height="25px" ToolTip="View" CommandName="viewdetail" CommandArgument='<%#Eval("RequestId") %>' />
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
