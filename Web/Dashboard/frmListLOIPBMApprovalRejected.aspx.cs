...
public partial class Dashboard_frmListLOIPBMApprovalRejected : System.Web.UI.Page
{
    ...
    protected void gvListLOI_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("UploadPrice"))
        {
            ...
            Response.Redirect("frmPBMApprovalRejected.aspx?RequestId=" + e.CommandArgument.ToString());
        }
    }
