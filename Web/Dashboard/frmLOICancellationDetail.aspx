<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmLOICancellationDetail.aspx.cs" Inherits="Dashboard_frmLOICancellationDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('h1.page-header').html('LOI Cancellation');
        });
        ...
        <ContentTemplate>
            <div class="text-right">
                <div class="form-inline">
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel LOI" CssClass="btn btn-info" OnClick="btnCancel_Click" />
                </div>
            </div>
            <div class="clearfix"></div>
            <h4></h4>
                    ...
                    <div class="form-group">
                        ...
                        <asp:GridView ID="gvLOIData" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="30" CssClass="Grid" Width="100%" OnRowCommand="gvLOIData_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="LOI_Detail_ID" HeaderText="LOI_Detail_ID" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
                            </Columns>
                        </asp:GridView>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <asp:GridView ID="gvSupDoc" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="30" CssClass="Grid" Width="100%" EmptyDataText="No Data Recorded" Font-Size="13px">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="availibilityName" HeaderText="Availibility" />
                            </Columns>
                        </asp:GridView>
                    </div>
                </div>
