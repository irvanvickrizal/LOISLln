...
public partial class Dashboard_frmUpdateSuppDocAvailability : System.Web.UI.Page
{
    ...
    {
        int RequestId = int.Parse(Request.QueryString["RequestId"]);
        gvSupDoc.DataSource = loiControllerr.supporting_document_getNotAvailable(RequestId);
        gvSupDoc.DataBind();
    }
