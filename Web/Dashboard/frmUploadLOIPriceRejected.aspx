<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmUploadLOIPriceRejected.aspx.cs" Inherits="Dashboard_frmUploadLOIPriceRejected" %>
        ...
        <div class="panel-body">
            ...
            <div class="row form-group">
                <div class="col-xs-5" style="text-align: left;">
                    ...
                    <asp:Button ID="btnDownloadTemplate" CssClass="btn btn-block btn-info" Text="Download List LOI Rejected (.xlsx)" runat="server" OnClick="btnDownloadTemplate_Click" />
