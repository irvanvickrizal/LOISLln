...
public partial class Dashboard_frmLOIClossingPending : System.Web.UI.Page
{
    ...
    protected void gvListLOI_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("viewdetail"))
        {
            ...
            Response.Redirect("frmLOIClossingPendingDetail.aspx?RequestId=" + e.CommandArgument.ToString());
        }
    }
    ...
    {
        gvListLOI.DataSource = loiControllerr.LOI_get_Uploaded_byStatus("Approved");
