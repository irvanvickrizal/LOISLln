...
using System.Data;
public partial class Dashboard_frmDashboardCDM : System.Web.UI.Page
{
    ...
    private void BindAgenda()
    {
        ...
        if (ApprovalCount > 0)
        {
            ...
            aViewApproval.HRef = "frmListLOICDM.aspx";
        }
        ...
        if (RejectedApprovalCount > 0)
        {
            ...
            aViewApprovalRejected.HRef = "frmListLOICDMApprovalRejected.aspx";
        }
    }
