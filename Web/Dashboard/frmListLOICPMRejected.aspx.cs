...
public partial class Dashboard_frmListLOICPMRejected : System.Web.UI.Page
{
    ...
    protected void gvListLOI_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("UploadPrice"))
        {
            ...
            Response.Redirect("frmCheckingSupportingDoc.aspx?RequestId=" + e.CommandArgument.ToString() + "&isRejected=1");
        }
    }
    ...
    {
        gvListLOI.DataSource = loiControllerr.LOI_get_UploadRejected(4);
