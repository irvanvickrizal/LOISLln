<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmApprovalCDM.aspx.cs" Inherits="Dashboard_frmApprovalCDM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="Server">
    <asp:HiddenField ID="hdnprojectname" runat="server" /> <%--Yunita 22 sep 2020 to show summary LOI overdue--%>
