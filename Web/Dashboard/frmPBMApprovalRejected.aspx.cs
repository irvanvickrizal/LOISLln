...
public partial class Dashboard_frmPBMApprovalRejected : System.Web.UI.Page
{
    ...
    protected void btnSubmitReject_Click(object sender, EventArgs e)
    {
        ...
        if (loiControllerr.LOI_Update_Approval_Status(RequestId, false, "CPM", txtReasonRejection.Value))
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('LOI has been Rejected Successfully'); location.href = '../dashboard/frmListLOIPBMApprovalRejected.aspx';", true);
            }
        }
        else
        {
