<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmLOIReportDetail.aspx.cs" Inherits="rpt_frmLOIReportDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('h1.page-header').html('LOI Report Detail');
        });
    </script>
</asp:Content>
    ...
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a href="#loiviewlog" data-toggle="tab">View Log</a></li>
            </ul>
            <div class="tab-content ">
                <div class="tab-pane active" id="loireport">
                    <asp:GridView ID="gvListLOI" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="30" CssClass="table table-condensed table-bordered"
                        EmptyDataText="You have 0 Task Pending" Font-Size="12px" OnRowCommand="gvListLOI_RowCommand" OnPageIndexChanging="gvListLOI_PageIndexChanging" OnRowDataBound="gvListLOI_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Total_Price" HeaderText="Total Price (IDR)" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:n0}" />
                            <asp:BoundField DataField="Qty" HeaderText="Qty" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="Upload_Date" HeaderText="Request Date" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd-MMM-yyyy}" />
                            <asp:BoundField DataField="MU_Approve_Date" HeaderText="Approve Date" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd-MMM-yyyy}" />
                            <asp:BoundField DataField="Uploaded_By" HeaderText="Requester" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="ProjectName" HeaderText="Project Name" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="Closing_Plan_Date" HeaderText="Plan Close LOI" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd-MMM-yyyy}" />
                            <asp:BoundField DataField="Closing_Actual_Date" HeaderText="LOI Close Date" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd-MMM-yyyy}" />
                            <asp:BoundField DataField="LOI_Status" HeaderText="Status LOI" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            ...
                            <asp:BoundField DataField="Cancelled_Date" HeaderText="LOI Cancel Date" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd-MMM-yyyy}" />
                            <asp:BoundField DataField="Cancelled_By" HeaderText="Cancelled By" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                        </Columns>
                    </asp:GridView>
                </div>
                <div class="tab-pane" id="loiviewlog">
                    <asp:GridView ID="gvLog" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="30" CssClass="table table-condensed table-bordered"
                        EmptyDataText="You have 0 Task Pending" Font-Size="12px" OnPageIndexChanging="gvLog_PageIndexChanging">
                        <HeaderStyle BackColor="#c7c5ff" HorizontalAlign="Center" />
                        <EmptyDataRowStyle CssClass="alert-warning" ForeColor="Red" />
                        <Columns>
