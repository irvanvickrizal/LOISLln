...
public partial class rpt_frmLOIDoneDetail : System.Web.UI.Page
{
    ...
    private void BindData(int pgIndex = 0)
    {
        ...
        gvListLOI.DataSource = loiControllerr.report_loi_done_detail_getdata(0, "", "", txtSiteNo.Value, txtCPO.Value, reqid);
    ...
    {
        Response.Redirect("~/rpt/frmLOIDone.aspx");
    }
}