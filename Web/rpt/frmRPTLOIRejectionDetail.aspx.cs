...
public partial class rpt_frmRPTLOIRejectionDetail : System.Web.UI.Page
{
    ...
    private void BindData(int pgIndex = 0)
    {
        ...
        gvListLOI.DataSource = loiControllerr.report_loi_rejection_detail_getdata(0, "", "", txtSiteNo.Value, txtCPO.Value, reqid);
    ...
    {
        Response.Redirect("~/rpt/frmRPTLOIRejection.aspx");
    }
}