<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmLOIDone.aspx.cs" Inherits="rpt_frmLOIDone" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('h1.page-header').html('LOI Done Report');
        });
    </script>
</asp:Content>
