<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmRPTLOIRejection.aspx.cs" Inherits="rpt_frmRPTLOIRejection" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('h1.page-header').html('LOI Rejection Report');
        });
    </script>
