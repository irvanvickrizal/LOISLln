<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmRPTOpenLOIDetail.aspx.cs" Inherits="rpt_frmRPTOpenLOIDetail" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="gvListLOI" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="30" CssClass="table table-condensed table-bordered"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="LOI_Status" HeaderText="Status LOI Approval" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                </Columns>
            </asp:GridView>
            <div class="clearfix"></div>
        </ContentTemplate>
