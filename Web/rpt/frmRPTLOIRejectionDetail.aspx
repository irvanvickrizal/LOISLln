<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="frmRPTLOIRejectionDetail.aspx.cs" Inherits="rpt_frmRPTLOIRejectionDetail" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="gvListLOI" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="30" CssClass="table table-condensed table-bordered"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Upload_Date" HeaderText="Request Date of LOI" HeaderStyle-CssClass="gridheader" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd-MMM-yyyy}"/>
